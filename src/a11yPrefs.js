...
// in SettingsScreen.
export const THEMES = ["dim", "light", "navy", "lightblue", "pastel", "pink", "heritage", "pride", "trans", "bisexual", "lesbian", "pansexual", "nonbinary", "asexual"];
...
export const IDENTITY_THEMES = ["pride", "trans", "bisexual", "lesbian", "pansexual", "nonbinary", "asexual"];
